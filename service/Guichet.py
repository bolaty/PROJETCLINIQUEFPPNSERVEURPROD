...
def pvgComboTypeshemacomptableVersement(connexion):
    ...
    # Requête SQL
    vapRequete = f"""
        SELECT TS_CODETYPESCHEMACOMPTABLE,TS_LIBELLE FROM dbo.TYPESCHEMACOMPTABLE WHERE TS_CODETYPESCHEMACOMPTABLE ='00023' OR TS_CODETYPESCHEMACOMPTABLE ='00024' ORDER BY TS_LIBELLE
    """
