...
def dashboard(connexion, cls_dashboard):
    ...
    try:
        ...
        for row in rows:
            ...
            result['NOMBRE_OM_GLOBAL'] = row.NOMBRE_OM_GLOBAL
            result['MONTANT_TOTAL_OM_GLOBAL'] = row.MONTANT_TOTAL_OM_GLOBAL
            result['NOMBRE_MOMO'] = row.NOMBRE_MOMO
            result['MONTANT_TOTAL_MOMO'] = row.MONTANT_TOTAL_MOMO
            result['NOMBRE_MOMO_GLOBAL'] = row.NOMBRE_MOMO_GLOBAL
            result['MONTANT_TOTAL_MOMO_GLOBAL'] = row.MONTANT_TOTAL_MOMO_GLOBAL
            result['NOMBRE_FLOOZ'] = row.NOMBRE_FLOOZ
            result['MONTANT_TOTAL_FLOOZ'] = row.MONTANT_TOTAL_FLOOZ
            result['NOMBRE_FLOOZ_GLOBAL'] = row.NOMBRE_FLOOZ_GLOBAL
            result['MONTANT_TOTAL_FLOOZ_GLOBAL'] = row.MONTANT_TOTAL_FLOOZ_GLOBAL
            result['NOMBRE_WAVE'] = row.NOMBRE_WAVE
            result['MONTANT_TOTAL_WAVE'] = row.MONTANT_TOTAL_WAVE
            result['NOMBRE_WAVE_GLOBAL'] = row.NOMBRE_WAVE_GLOBAL
            result['MONTANT_TOTAL_WAVE_GLOBAL'] = row.MONTANT_TOTAL_WAVE_GLOBAL
