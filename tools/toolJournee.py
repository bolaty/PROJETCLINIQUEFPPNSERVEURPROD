...
def test_journee_fermeeVersement(connexion, *vppCritere):
    cursor = connexion
    ...
    try:
        ...
        if results[0]['NBRE'] != 0:
            clsOperateur= pvgTableLabelVersement(connexion, vppCritere);
...
def pvgTableLabelVersement(connexion, vppCritere):
    cursor = connexion
